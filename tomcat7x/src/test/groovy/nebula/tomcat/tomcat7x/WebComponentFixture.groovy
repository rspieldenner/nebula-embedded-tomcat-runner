...
class WebComponentFixture {
    ...
    private File createJavaSourceDirectory(File projectDir) {
        File javaSrcDir = new File(projectDir, 'src/main/java/nebula/tomcat/embedded/web')
    ...
    private void createSimpleServlet(File srcDir) {
        ...
        servletFile << """
package nebula.tomcat.embedded.web;
...
<web-app version="2.5" xmlns="http://java.sun.com/xml/ns/javaee"
    ...
    <servlet>
        ...
        <servlet-class>nebula.tomcat.embedded.web.SimpleServlet</servlet-class>
        <load-on-startup>1</load-on-startup>
    </servlet>
    <servlet>
        <servlet-name>ForwardServlet</servlet-name>
        <servlet-class>nebula.tomcat.embedded.web.ForwardServlet</servlet-class>
